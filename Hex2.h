...
struct Hex2 {
	...
	Player CAN_RED_WIN_IN_1_MOVE_WITH_PERFECT_OPPONENT(const short& state, short emptyCounter);
	Player CAN_BLUE_WIN_IN_1_MOVE_WITH_PERFECT_OPPONENT(const short& state, short emptyCounter);

	void CAN_WIN_IN_2_MOVES_WITH_PERFECT_OPPONENT(Player afterDFS[], const short& state, const Player& player, short emptyCounter);
